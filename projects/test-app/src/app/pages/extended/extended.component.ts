...
@Component({
    ...
    imports: [TranslatePipe, LanguageSwitchComponent, NestedComponent, HierarchyVizComponent],
    providers: [
    ...
    template: `
        <div class="card">
            ...
            <div class="info-box info">
                This component uses <code>provideChildTranslateService()</code>. 
                It has its own translations but <strong>falls back</strong> to the parent (root) 
                for missing keys. It also inherits the global language state.
            </div>
            ...
            <div class="demo-grid">
                <div class="sub-card">
                    ...
                    <div class="translation-item">
                        ...
                        <em style="font-size: 0.7rem; color: var(--accent); display: block;">(Overridden locally)</em>
                    </div>
                </div>
