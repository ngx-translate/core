...
@Component({
  ...
  template: `
    ...
    <div #withParams [translate]="'TEST'" [translateParams]="value">
      Some init content
    </div>
    ...
    <div #withSpaceAndLineBreakNoKeyNoParams translate>TEST</div>
  `,
})
class AppComponent {
  ...
  @ViewChild("withOtherElements", { static: true })
  withOtherElements!: ElementRef;
  ...
  @ViewChild("leadingSpaceNoKeyNoParams")
  leadingSpaceNoKeyNoParams!: ElementRef;
  @ViewChild("trailingSpaceNoKeyNoParams")
  trailingSpaceNoKeyNoParams!: ElementRef;
...
describe("TranslateDirective (standalone)", () => {
  ...
  it("should translate a string using the container value as a key", () => {
    expect(
      fixture.componentInstance.contentAsKey.nativeElement.innerHTML,
    ).toEqual("TEST.VALUE");
  ...
  it("should translate a string using the key value", () => {
    ...
    expect(fixture.componentInstance.withKey.nativeElement.innerHTML).toEqual(
      "TEST",
    );
  ...
  it("should translate first child strings with elements in the middle", () => {
    // replace the content with the key
    expect(
      fixture.componentInstance.withOtherElements.nativeElement.innerHTML,
    ).toEqual("TEST1 <span>Hey</span> TEST2");
    ...
    expect(
      fixture.componentInstance.withOtherElements.nativeElement.innerHTML,
    ).toEqual("Awesome <span>Hey</span> it works");
  });
  ...
  it("should translate first child strings without recursion", () => {
    ...
    expect(
      fixture.componentInstance.withOtherElements.nativeElement.innerHTML,
    ).toEqual("TEST2 <span>Hey</span> it works");
  });

  it("should translate a string with params and a key", () => {
    // replace the content with the key
    expect(
      fixture.componentInstance.withParams.nativeElement.innerHTML,
    ).toEqual("TEST");
  ...
  it("should translate a string with params and no key", () => {
    // replace the content with the key
    expect(
      fixture.componentInstance.withParamsNoKey.nativeElement.innerHTML,
    ).toEqual("TEST");
  ...
  it("should update the DOM when the lang changes and the translation key starts with space", () => {
    expect(
      fixture.componentInstance.leadingSpaceNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual(" TEST");

    const en = "This is a test - with leading spaces in translation key";
    const fr =
      "C'est un test - avec un espace de tête dans la clé de traduction";
    ...
    expect(
      fixture.componentInstance.leadingSpaceNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual(leadingSpaceFromKey + en);

    translate.use("fr");
    expect(
      fixture.componentInstance.leadingSpaceNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual(leadingSpaceFromKey + fr);
  });

  it("should update the DOM when the lang changes and the translation key has line breaks and spaces", () => {
    expect(
      fixture.componentInstance.withSpaceAndLineBreakNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual(" TEST ");

    const en = "This is a test - with trailing spaces in translation key";
    const fr =
      "C'est un test - avec un espace de fuite dans la clé de traduction";
    ...
    expect(
      fixture.componentInstance.withSpaceAndLineBreakNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual(whiteSpaceFromKey + en + whiteSpaceFromKey);

    translate.use("fr");
    expect(
      fixture.componentInstance.withSpaceAndLineBreakNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual(whiteSpaceFromKey + fr + whiteSpaceFromKey);
  });

  it("should update the DOM when the lang changes and the translation key ends with space", () => {
    expect(
      fixture.componentInstance.trailingSpaceNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual("TEST ");

    const en =
      "This is a test - with spaces and line breaks in translation key";
    const fr =
      "C'est un test - avec des espaces et sauts de lignes dans la clé de traduction";
    ...
    expect(
      fixture.componentInstance.trailingSpaceNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual(en + trailingSpaceFromKey);

    translate.use("fr");
    expect(
      fixture.componentInstance.trailingSpaceNoKeyNoParams.nativeElement
        .innerHTML,
    ).toEqual(fr + trailingSpaceFromKey);
  });
  ...
  it("should update the DOM when the lang changes and the translation ends with space", () => {
    ...
    expect(fixture.componentInstance.noContent.nativeElement.innerHTML).toEqual(
      "TEST",
    );
