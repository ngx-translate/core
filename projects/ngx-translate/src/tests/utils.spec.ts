...
describe("Utils", () => {
  ...
  describe("getValue()", () => {
    it("should get the addressed value", () => {
      expect(getValue({ key1: { key2: "value2" } }, "key1.key2")).toEqual(
        "value2",
      );
      expect(
        getValue({ key1: { key2: "value" } }, "keyWrong.key2"),
      ).not.toBeDefined();
      expect(
        getValue({ key1: { key2: { key3: "value3" } } }, "key1.key2.key3"),
      ).toEqual("value3");
      expect(
      ...
      expect(
        getValue({ "key1.key2": { key3: "value3" } }, "key1.key2"),
      ).toEqual({ key3: "value3" });
    });
