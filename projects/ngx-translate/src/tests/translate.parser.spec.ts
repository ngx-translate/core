...
describe("Parser", () => {
  ...
  describe("interpolate()", () => {
    it("should interpolate strings", () => {
      expect(
        parser.interpolate("This is a {{ key }}", { key: "value" }),
      ).toEqual("This is a value");
    });

    it("should interpolate strings with falsy values", () => {
      expect(parser.interpolate("This is a {{ key }}", { key: "" })).toEqual(
        "This is a ",
      );
      expect(parser.interpolate("This is a {{ key }}", { key: 0 })).toEqual(
        "This is a 0",
      );
    });
    ...
    it("should interpolate strings with object properties", () => {
      expect(
        parser.interpolate("This is a {{ key1.key2 }}", {
          key1: { key2: "value2" },
        }),
    ...
    it("should handle edge cases: bool", () => {
      expect(
        parser.interpolate("This is a bool: {{ key1.key2 }}", {
          key1: { key2: true },
        }),
    ...
    it("should handle edge cases: object", () => {
      ...
      ).toEqual("This is a [object Object]");
    });
    ...
    it("should handle edge cases: object", () => {
      ...
      expect(
        parser.interpolate("This is {{ key1.key2 }}", {
          key1: { key2: object },
        }),
